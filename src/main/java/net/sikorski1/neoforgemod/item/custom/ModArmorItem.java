...
import net.sikorski1.neoforgemod.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    ...
    private boolean hasFullSuitOfArmorOn(Player player) {
        ItemStack boots = player.getInventory().getItem(0);
        ItemStack leggings = player.getInventory().getItem(1);
        ItemStack chestplate = player.getInventory().getItem(2);
        ItemStack helmet = player.getInventory().getItem(3);
