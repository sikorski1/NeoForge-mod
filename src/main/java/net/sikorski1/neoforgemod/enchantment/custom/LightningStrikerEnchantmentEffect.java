package net.sikorski1.neoforgemod.enchantment.custom;
...
public record LightningStrikerEnchantmentEffect() implements EnchantmentEntityEffect {
    ...
    @Override
    public void apply(ServerLevel serverLevel, int enchantmentLevel, EnchantedItemInUse enchantedItemInUse,
                      Entity entity, Vec3 vec3) {
