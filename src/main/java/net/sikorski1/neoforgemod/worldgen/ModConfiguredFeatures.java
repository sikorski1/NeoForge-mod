package net.sikorski1.neoforgemod.worldgen;
...
public class ModConfiguredFeatures {
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> GOJI_BERRY_BUSH_KEY = registerKey("goji_berry_bush_key");
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        List<OreConfiguration.TargetBlockState> overworldBismuthOres = List.of(
                ...
                OreConfiguration.target(deepslateReplaceables,
                        ModBlocks.BISMUTH_DEEPSLATE_ORE.get().defaultBlockState()
                )
        );
        ...
        register(context, BLOODWOOD_KEY, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                RotatedBlockProvider.simple(ModBlocks.BLOODWOOD_LOG.get()),
                new BendingTrunkPlacer(7, 4, 7, 5, UniformInt.of(2, 5)),

                BlockStateProvider.simple(ModBlocks.BLOODWOOD_LEAVES.get()),
                new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(3), 6),

                new TwoLayersFeatureSize(1, 0, 2)).dirt(BlockStateProvider.simple(Blocks.NETHERRACK))
                .build()
        );
        ...
        register(context, GOJI_BERRY_BUSH_KEY, Feature.RANDOM_PATCH,
                FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
                        new SimpleBlockConfiguration(
                                BlockStateProvider.simple((BlockState) ModBlocks.GOJI_BERRY_BUSH.get().defaultBlockState().setValue(SweetBerryBushBlock.AGE, 3))),
